...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <h1>Lista aaaaaaaaaaa</h1>  

        <div class="row mb-2 bg-primary text-light text-center">
        ...
        <div class="row text-center">
            ...
            <div class="col-2 icones">
              <a href="ver_cliente.php?id=<?php echo $id ?>">
                <img src="img/ver.png" alt="">
              </a>
              <a href="editar_cliente.php?id=<?php echo $id ?>">
                <img src="img/editar.png" alt="">
              </a>
              <a href="excluir_cliente.php?id=<?php echo $id ?>" onclick="return confirm('Confirma a exclusão do Cliente?')">
