    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-2 icones">
              <a href="ver_aluno.php?id=<?php echo $id ?>">
                <img src="img/ver.png" alt="">
              </a>
              <a href="editar_aluno.php?id=<?php echo $id ?>">
                <img src="img/editar.png" alt="">
              </a>
              <a href="excluir_aluno.php?id=<?php echo $id ?>" onclick="return confirm('Confirma a exclusão do Aluno?')">
